...
\begin{itemize}
    \item Meta Type Advantage Metric: Features calculated based on cross-damage multipliers between a team's offensive types and the opponent's defensive resistances. \textit{Rationale:} The type system is the most critical $matchup$ mechanic; its inclusion is strategic.
