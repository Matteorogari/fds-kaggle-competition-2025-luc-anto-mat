...
def compute_base_stat_differences(p1_team_state, p2_team_state, stat_registry):
    ...
    for pokemon in p1_team_state.keys():
        if pokemon in stat_registry:
            ...
            p1_total_defense += stat_registry[pokemon]['base_def']
    ...
    for pokemon in p2_team_state.keys():
        if pokemon in stat_registry:
            ...
            p2_total_defense += stat_registry[pokemon]['base_def']
    ...
    defense_sum_diff = p1_total_defense - p2_total_defense
    ...
    return speed_sum_diff, defense_sum_diff, attack_sum_diff, sp_attack_sum_diff, sp_defense_sum_diff, hp_sum_diff
...
def compute_final_features(source_data: list[dict]) -> pd.DataFrame:
    ...
    for battle in tqdm(source_data, desc="Extracting features"):
        ...
        current_features['defense_sum_diff'] = defense_sum_diff
