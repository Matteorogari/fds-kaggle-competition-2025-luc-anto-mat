...
The **optimal classification threshold** was set at $\mathbf{0.466}$ (lower than the neutral $0.5$). This adjustment was crucial to maximize overall accuracy, compensating for the aggregated model's slight tendency to be conservative in predicting Player 1's victory.

\section{Conclusions}
Maximum accuracy ($85.26\%$) in the Pokémon battle prediction task was achieved by integrating three methodological elements: 
\begin{enumerate}
    \item \textbf{Domain-specific feature engineering} (e.g., type advantage).
    \item Use of a \textbf{Stacking Ensemble} to combine linear and non-linear signals.
    \item \textbf{Threshold calibration} ($\mathbf{0.466}$).
\end{enumerate}
