...
# Import constants and maps from .constants
...
def compute_final_features(source_data: list[dict]) -> pd.DataFrame:
    ...
    for battle_record in tqdm(source_data, desc="Costruzione Matrice di Feature"):
        ...
        #Intermediate calculations for the Team status
        ...
        #difference in the total speed sum
        ...
        # Defensive vulnerability report of P1 against P2. Higher = P1 is more exposed to P2's attack types, indicating a defensive weakness.
        current_features['p1_def_type_vulnerability_ratio'] = p1_type_vuln
        # FEATURE OF THE FINAL ACTIVE LEAD
